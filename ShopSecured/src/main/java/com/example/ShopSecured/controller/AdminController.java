...
import com.example.ShopSecured.repository.GameCatagoryRepository;
...
import com.example.ShopSecured.model.*;
...
//        model.addAttribute("title", "Hello " + userRepository.findById(CurrentUser.getId()).get().getName());
    ...
    public String processAddAdminForm(@ModelAttribute User newUser,
...
//        newUser.setType(UserType.ADMIN);
    ...
    public String processAddGameForm(@ModelAttribute Game newGame,
                                      Errors errors, Model model) {
        if(errors.hasErrors()) {
            model.addAttribute("title", "Add Game");
            return "admin/games";
    ...
    public String processAddTypeForm(@ModelAttribute GameType newType,
                                     Errors errors, Model model) {
        if(errors.hasErrors()) {
            model.addAttribute("title", "Add Game Type");
